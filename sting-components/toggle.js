module.exports = Toggle = (styles) => ({ 
    ...
    '.toggle-btn': {
        '@apply relative inline-flex h-5 w-10 flex-shrink-0 cursor-pointer items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2' : {}
    },
    '.toggle-btn-default': {
    ...
    '.toggle-switch': {
        '@apply pointer-events-none absolute left-0 inline-block h-5 w-5 transform rounded-full border border-neutral-300 bg-white shadow ring-0 transition-transform duration-200 ease-in-out' : {}
    },    
