                    ...
                    <tbody class="divide-y divide-neutral-100 bg-white">
                      <tr>
                        ...
                        <td class="whitespace-nowrap py-4 pr-3 cb-text-copy-regular">
                          <div class="flex items-center">
                            <div>
                              ...
                              <div class=" text-neutral-500">tristique@example.com</div>
                            </div>
                          </div>
                        </td>
                        <td class="whitespace-nowrap px-3 py-4 cb-text-copy-regular">
                          <div class="flex items-center">
                            <div>
                              <div >Turpis Egestas</div>
                              <div class="text-neutral-500">Eget Aliquet</div>
                            </div>
                          </div>
                        </td>
                        ...
                        <td class="whitespace-nowrap px-3 py-4 cb-text-copy-regular "> Netus</td>
                        <td class="whitespace-nowrap px-3 py-4 cb-text-copy-regular "> Netus</td>
                        <td class="whitespace-nowrap py-4 pl-3 pr-4 sm:pr-6 py-2 flex justify-end">
                        <button type="button" class="btn btn-outline border-0">
