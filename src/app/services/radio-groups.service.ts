          ...
          <fieldset>
              ...
              <div class="bg-white rounded-md -space-y-px">
                ...
                <label class="rounded-tl-md rounded-tr-md radio-table__panel  radio-table--checked">
                  <input type="radio" checked name="privacy-setting" value="Public access" class="h-4 w-4 mt-0.5 cursor-pointer shrink-0 text-primary-600 border-gray-300 focus:ring-primary-500" aria-labelledby="privacy-setting-0-label" aria-describedby="privacy-setting-0-description">
              ...
              <div class="relative bg-white rounded-md -space-y-px">
                ...
                <label class="rounded-tl-md rounded-tr-md radio-table radio-table--checked">
                  <span class="flex items-center text-sm">
                    <input type="radio" name="pricing-plan" checked value="Startup" class="radio-table__input" aria-labelledby="pricing-plans-0-label" aria-describedby="pricing-plans-0-description-0 pricing-plans-0-description-1">
                    <!-- Checked: "text-primary-900", Not Checked: "text-gray-900" -->
