module.exports = InputGroups = (styles) => ({
  ...
  '.form-control .input-error': {
      "@apply block w-full pr-10 border-red-500 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm rounded-md text-red-900": {},
  },
  '.form-control .error-text': {
      "@apply mt-2 cb-text-copy-small text-red-800": {},
  },
