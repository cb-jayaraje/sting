module.exports = Tabs = (styles) => ({
    ...
    '.tab-link': {
        '@apply border-transparent whitespace-nowrap pt-4 pb-3 px-1 border-b-2 cb-text-copy-regular !font-normal hover:text-neutral-800': {}
    },
    '.tab-link-active': {
    ...
    '.tab-pill': {
        '@apply cb-text-copy-regular px-3 py-2 rounded hover:bg-neutral-100 shadow': {}
    },
    '.tab-pill-active': {
