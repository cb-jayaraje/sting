  ...
  <div class="ml-3">
    ...
    <div class="mt-4">
      <div class="-mx-2 -my-1.5 flex gap-x-3">
        <button type="button" class="alert-btn btn-success">View status</button>
        <button type="button" class="alert-btn  btn-success">Dismiss</button>
      </div>
    </div>
  </div>
</div>
 ...
 <div class="flex">
   ...
   <div class="ml-auto pl-3">
     <div class="-mx-1.5 -my-1.5">
       <button type="button" class="alert-btn btn-success">
