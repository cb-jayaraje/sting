        ...
        <button type="button" class="alert-btn  alert-btn-success">Dismiss</button>
         ...
         },
         {
            "id": "alert_4",
             ...
             "code": `
             <div class="alert bg-neutral-100">
<div class="flex">
<div class="flex-shrink-0">
 <svg class="h-5 w-5 text-neutral-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
   <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
 </svg>
</div>
<div class="ml-3 flex-1 md:flex md:justify-between">
 <p class="description-only text-neutral-800">A new software update is available. See what’s new in version 2.0.4.</p>
 <p class="mt-3 description-only md:mt-0 md:ml-6">
   <a href="#" class="alert-a text-neutral-800 hover:text-neutral-600">Details <span aria-hidden="true">&rarr;</span></a>
 </p>
</div>
</div>
</div>
         ...
         },
         {
            "id": "alert_5",
             ...
             "code": `
             <div class="alert accent-border alert-warning border-orange-600 ">
<div class="flex">
  <div class="flex-shrink-0">
 ...
 <div class="flex">
   ...
   <div class="ml-3 description-only">
     <p class="title">Successfully uploaded</p>
   </div>
