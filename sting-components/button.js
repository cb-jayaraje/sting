module.exports = Button = (styles) => ({
    ' .btn': {
        '@apply antialiased whitespace-nowrap items-center rounded border border-transparent bg-white px-4 py-2 text-sm font-medium cb-text-copy-regular hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-30 cursor-pointer items-start': {},
    },
    '.btn-small': {
    ...
    '.theme-sting .btn-primary': {
        '@apply text-white !bg-primary-800 hover:!bg-primary-900 active:!bg-primary-800 focus:ring-primary-500 border border-primary-900 focus:outline-none drop-shadow-sm': {},
    },
    '.theme-sting .btn-secondary': {
        '@apply text-primary-800 !bg-neutral-200 hover:!bg-neutral-300 active:!bg-neutral-50 focus:ring-primary-500 border border-neutral-300 hover:text-primary-900 focus:outline-none drop-shadow-sm': {},
    },
    '.theme-sting .btn-info': {
        '@apply text-white !bg-info-800 hover:!bg-info-900 active:!bg-info-800 focus:ring-info-500 border border-info-900 hover:text-white focus:outline-none drop-shadow-sm': {},
    },
